...
class CompositeFunction:
    ...
    def construct_model_from_str(
        ...
        for prim in prim_names:
            ...
            if not valid:
                logger(
                    f"CompositeFunction.construct_model_from_str(): dict=",
                ...
                error_handler(
                    f"CompositeFunction.construct_model_from_str(): Couldn't find a valid version of "
...
def do_new_things():
    ...
    values = [
        rng.normalvariate(mu=3.14159 * scipy.special.jv(0, 1.618 * x), sigma=sigma)
        for x in positions
    ]
