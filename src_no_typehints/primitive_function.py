...
class PrimitiveFunction:
    ...
    def __init__(self, func = None,
                 name = "", arg = 1., other_callable = None):

        self._callable_1param = other_callable
    ...
    #
    # @staticmethod
    # def pow1_fpos(x, arg)  :  # to delete
    #     return arg*x if arg > 0 else 1e5
    # @staticmethod
    # def pow1_fneg(x, arg)  :  # to delete
    #     return arg*x if arg < 0 else 1e5
    # @staticmethod
    # def pow_neg1_fpos(x, arg)  :  # to delete
    #     return arg/x if arg > 0 else 1e5
    # @staticmethod
    # def pow2_fneg(x, arg)  :  # to delete
    ...
    def pow1_shift(x,arg):  # for Sigmoid
        return x-arg
    @staticmethod
    def exp_dim1(x,arg)  :  # for Sigmoid
        return np.exp(-x/arg) if arg > 0 else 0
    @staticmethod
    def n_exp_dim2(x,arg)  :  # for Normal
