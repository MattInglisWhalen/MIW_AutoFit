...
class CompositeFunction:
    ...
    def __init__(self,
        ...
        self._children_list = []
        self._younger_brother = None
        self._older_brother = None
        self._parent = parent
        ...
        self._is_submodel = False
        self._submodel_zero_index = None
        self._submodel_of = None
    ...
    def build_built_in_dict()  :
        ...
        # linear model, b as parameters (roughly)
        ...
        # Gaussian, mu, sigma as parameters (roughly)
        ...
        # Normal, sigma as parameters (roughly)
